  ...
  <div class="slidebar">
    ...
    <ul class="slide_item">
      <li class="item">
        ...
        <ul>
          <li>
            <a :class="{ on: current === 'order' }" @click="toOrder"
              >我的订单</a
            >
            <a :class="{ on: current === 'receive' }" @click="toReceive"
              >收货地址</a
            >
          </li>
        </ul>
      ...
      <li class="item">
        ...
        <ul>
          <li>
            <a :class="{ on: current === 'userinfo' }" @click="toUserInfo"
              >用户信息</a
            >
            <a :class="{ on: current === 'collection' }" @click="toCollection"
              >我的收藏</a
            >
            <a :class="{ on: current === 'message' }" @click="toMessage"
              >我的留言</a
            >
          </li>
        </ul>
