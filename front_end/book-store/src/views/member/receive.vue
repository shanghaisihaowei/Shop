              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="left" bgcolor="#ffffff">
                    ...
                    />
                    <span :class="{ error: item.signer_name == '' }"
                      >(必填)</span
                    >
                  </td>
                </tr>
                <tr>
                  ...
                  <td align="left" bgcolor="#ffffff">
                    ...
                    />
                    <span :class="{ error: item.address == '' }">(必填)</span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td align="left" bgcolor="#ffffff">
                    <input
                      ...
                      class="inputBg"
                      id="mobile_0"
                      v-model="item.signer_mobile"
                    /><span :class="{ error: item.signer_mobile == '' }"
                      >(必填)</span
                    >
                  </td>
                </tr>
                <tr>
                  ...
                  <td colspan="3" align="center" bgcolor="#ffffff">
                    ...
                    <button
                      class="bnt_blue_2"
                      @click="confirmUpdate(item.id, index)"
                    >
                      确定修改
                    </button>
                    <button class="bnt_blue_2" @click="deleteInfo(item.id)">
                      删除
                    </button>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="left" bgcolor="#ffffff">
                    ...
                    />
                    <span :class="{ error: newInfo.signer_name == '' }"
                      >(必填)</span
                    >
                  </td>
                </tr>
                <tr>
                  ...
                  <td align="left" bgcolor="#ffffff">
                    ...
                    />
                    <span :class="{ error: newInfo.address == '' }"
                      >(必填)</span
                    >
                  </td>
                </tr>
                <tr>
                  ...
                  <td align="left" >
                    <input
                      ...
                      class="inputBg"
                      id="mobile_0"
                      v-model="newInfo.signer_mobile"
                    /><span :class="{ error: newInfo.signer_mobile == '' }"
                      >(必填)</span
                    >
                  </td>
                </tr>
                <tr>
                  ...
                  <td colspan="3" align="center" bgcolor="#ffffff">
                    <!-- <input type="submit" name="submit" class="bnt_blue_2" value="新增收货地址"> -->
                    <button class="bnt_blue_2" @click="addReceive">
                      新增收货地址
                    </button>
