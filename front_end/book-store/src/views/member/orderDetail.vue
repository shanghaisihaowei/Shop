            ...
            >
              <tbody>
                ...
                <tr>
                  ...
                  <td
                    v-if="orderInfo.pay_status == 'paying'"
                    align="left"
                    bgcolor="#ffffff"
                  >
                    待支付&nbsp;&nbsp;&nbsp;&nbsp;
                    <div style="text-align: center">
                      <a :href="orderInfo.alipay_url"
                        ><input
                          type="button"
                          onclick=""
                          value="立即使用支付宝支付"
                  ...
                  <td
                    v-if="orderInfo.pay_status == 'TRADE_SUCCESS'"
                    align="left"
                    bgcolor="#ffffff"
                  >
                    已支付
            ...
            >
              <tbody>
                ...
                <tr v-for="item in orderInfo.goods" :key="item.id">
                  ...
                  <td align="center" bgcolor="#ffffff">
                    ￥{{ item.goods.shop_price * item.goods_num }}元
                  </td>
                </tr>
                <tr>
                  ...
                  <tr>
                    ...
                    <td align="left" bgcolor="#ffffff">
                      <input
                        ...
                        type="text"
                        class="inputBg"
                        v-model="orderInfo.singer_mobile"
                        size="25"
                      />
                    </td>
                  </tr>
