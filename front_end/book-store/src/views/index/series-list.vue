    ...
    <div class="series_list" v-for="items in list">
      <div class="series_box cle">
        ...
        <div class="series_pic">
          <router-link :to="'/app/home/productDetail/' + 17" target="_blank">
            <img
              src="http://myphoto.mtianyan.cn/blog/180426/4I5aaJH64j.png?imageslim"
              width="340"
              height="400"
            />
          </router-link>
        ...
        <div class="pro_list">
          <ul class="cle">
            <li v-for="list in items.goods">
              <router-link
                :to="'/app/home/productDetail/' + list.id"
                target="_blank"
              >
                <p class="pic">
                ...
                <h3>{{ list.name }}</h3>
                <p class="price">￥{{ list.shop_price }}元</p>
              </router-link>
            </li>
          </ul>
        </div>
