      ...
      <div class="bd_bar_bd cle">
        <ul class="welcome">
          <li id="ECS_MEMBERZONE" v-if="userInfo.name">
            <router-link :to="'/app/home/member/userinfo'">{{
              userInfo.name
            }}</router-link>
            &nbsp;[
        ...
        <ul id="userinfo-bar">
          <li
            class="more-menu"
            @mouseover="isShowVip = true"
            @mouseout="isShowVip = false"
          >
            <a>会员中心</a><i class="iconfont arrow"> </i>
            <div class="more-bd" :class="{ show: isShowVip }">
              <div class="list">
                <router-link :to="'/app/home/member/order'"
                  >我的订单</router-link
                >
                <router-link :to="'/app/home/member/collection'"
                  >我的收藏</router-link
                >
          ...
          >
            <router-link
              :to="'/app/shoppingcart/cart'"
              target="_blank"
              style="text-align: center"
            >
              购物车
              <!-- <em class="num" id="hd_cartnum" style="visibility: visible">{{
                goods_list.goods_list.length
              }}</em> -->
            </router-link>
            <div class="list" v-show="showShopCar">
              <div class="data">
                <dl
                  v-for="(item, index) in goods_list.goods_list"
                  :key="item.goods.id"
                >
                  <dt>
                    <router-link
                  ...
                  <dd>
                    ...
                    <a
                      title="删除"
                      class="iconfont del"
                      @click="deleteGoods(index, item.goods.id)"
                      >×</a
                    >
                  </dd>
                </dl>
              ...
              <div class="count">
                共<span class="red" id="hd_cart_count">{{
                  goods_list.goods_list.length
                }}</span
                >件商品哦~
                <p>
      ...
      <div class="hd_nav_bd cle">
        <div class="main_nav main_nav_hover" id="main_nav">
          ...
          >
            <a
              class="meunAll"
              style="padding: 0; height: 35px; line-height: 35px"
              >全部商品分类
            </a>
        ...
        <ul class="sub_nav cle" id="sub_nav">
          ...
          <template v-for="item in allMenuLabel">
            <li>
...
.hd_bar ul#userinfo-bar li .vipico {
  width: 12px;
  height: 17px;
  /*background:url(http://47.98.167.5:8000/images%5Chead/wap.png) no-repeat;*/
  float: left;
  margin-right: 4px;
  font-size: 18px;
}
...
.week-hot .item .hot-ico {
  /* background:url(http://47.98.167.5:8000/images%5Chead/hot-ico-bg.png) -48px 0 no-repeat;*/
  display: block;
  width: 40px;
  height: 40px;
  overflow: hidden;
