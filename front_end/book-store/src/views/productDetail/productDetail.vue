            ...
            <dd class="property">
              <ul>
                ...
                <li>
                  ...
                  ><span class="unit">
                    <strong class="nala_price red" id="ECS_SHOPPRICE"
                      >￥{{ proDetail.shop_price }}元</strong
                    >
                  </span>
                ...
                <li>
                  ...
                  ><span
                    >最近售出<em class="red">{{ proDetail.sold_num }}</em
                    >件</span
                  >
                </li>
              </ul>
              ...
              <ul class="sku">
                <li class="skunum_li cle">
                  ...
                  <div class="skunum" id="skunum">
                    <span class="minus" title="减少1个数量" @click="reduceNum"
                    ...
                    <input
                      ...
                      onchange="countNum(0)"
                    />
                    <span class="add" title="增加1个数量" @click="addNum"
                      ><i class="iconfont">+</i></span
                    >
                  ...
                  <div class="skunum" id="skunum">
                    <cite class="storage"
                      >(<font id="shows_number"
                        >库存: {{ proDetail.goods_num }}件</font
                      >)</cite
                    >
                  </div>
                </li>
                <li class="add_cart_li">
                  ...
                  <a v-else class="btn" id="buy_btn" @click="addShoppingCart">
                    加入购物车
                  </a>
                  ...
                  >
                    已收藏</a
                  >
                  <a v-else class="btn" @click="addCollect"> 收藏</a>
                </li>
              </ul>
            </dd>
          </dl>
...
export default {
  ...
  methods: {
    ...
    ImageNext() {
      this.curIndex =
        this.curIndex === this.proDetail.detailImages.length - 1
          ? this.proDetail.detailImages.length - 1
          : this.curIndex + 1;
    },
